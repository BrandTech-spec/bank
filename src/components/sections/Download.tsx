...
import { Marker } from "../home_page/Marker";
...
const Download = () => {
  return (
    <section>
      <Element
        name="download"
        className="g7 relative text-white pb-32 pt-24 max-lg:pb-24 max-md:py-16"
      >
            ...
            <div className="mb-10 max-md:hidden">
              <div className="download_preview-before download_preview-after rounded-40 relative w-[955px] border-2 border-s5 p-6">
                <div className="relative rounded-3xl bg-s1 px-6 pb-6 pt-14">
                  ...
                  <img
                    src="public\img\bank_icons\Capture dՎcran 2025-02-10 223115.png"
                    width={855}
                    height={655}
                    alt="screen"
